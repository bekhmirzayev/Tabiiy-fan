      ...
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          {items.filter(i => i.type === 'video').map((item) => (
            <div key={item.id} className="bg-white dark:bg-slate-900 rounded-2xl shadow-sm overflow-hidden border border-slate-200 dark:border-slate-800 group cursor-pointer hover:border-blue-300 dark:hover:border-blue-700 transition-colors">
              <div className="relative aspect-video bg-slate-900 flex items-center justify-center">
                  ...
                  <div className="w-16 h-16 bg-red-600 rounded-full flex items-center justify-center z-10 group-hover:scale-110 transition-transform shadow-lg">
        ...
        {items.some(i => i.type === 'article') && (
          <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-200 dark:border-slate-800">
              <h3 className="font-bold text-slate-800 dark:text-slate-100 mb-4 flex items-center">
                <FileText className="mr-2 text-blue-500" size={20}/> Qo'shimcha o'qish uchun:
              </h3>
